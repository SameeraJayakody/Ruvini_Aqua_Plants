	...
	<%   Connection con;
	   ...
	   String url,user,pass;
	      ...
	      try {
			...
			out.print("<td class=\"text-center\"><a href =\"updatedata.jsp?u="+rs.getString("chemicalcode")+"\" class = \"btn btn-warning\"> Edit </a></td><td><a href =\"deletec?u=" +rs.getString("chemicalcode")+" \"class =\"btn btn-danger \"> Delete </a></td><td><a href =\"reorder.jsp?u=" +rs.getString("chemicalcode")+" \"class =\"btn btn-danger \"> Re-order </a></td>");
			out.print("</tr>");
