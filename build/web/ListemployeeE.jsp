	...
	<%   Connection con;
	   ...
	   String url,user,pass;
	      ...
	      try {
			...
			out.print("<td class=\"text-center\"><a href =\"index1.jsp?u="+rs.getString("equipmentcode")+"\" class = \"btn btn-warning\"> Edit </a></td><td><a href =\"deletee?u=" +rs.getString("equipmentcode")+" \"class =\"btn btn-danger \"> Delete </a></td><td><a href =\"reorder.jsp?u=" +rs.getString("equipmentcode")+" \"class =\"btn btn-danger \"> Re-order </a></td>");
			out.print("</tr>");
